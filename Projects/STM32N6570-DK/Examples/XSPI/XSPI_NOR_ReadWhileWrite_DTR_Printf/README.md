## <b>XSPI_NOR_ReadWhileWrite_DTR_Printf Example Description</b>

How to write and read data on XSPI NOR memory (bank1) when code is executed from bank0,
with printf logging enabled to trace XSPI command execution.
...
This is an enhanced version of the XSPI_NOR_ReadWhileWrite_DTR example with the following additions:
- USART1 is configured for printf functionality (115200 baud, 8N1)
- Printf statements are added after each HAL_XSPI_Command call to log CCR and TCR register values
- Output format: "COMMAND_NAME: CCR=0x%08lx TCR=0x%08lx\r\n"
- UART pins: PE5 (TX), PE6 (RX)
